...
//            JYDLogUtil.e("getOneDeviceId error");
        }
        return OneId;
    }
        ...
        try {
            ...
            if (macSerial == null || "".equals(macSerial)) {
                try {
                    ...
                    //ex.printStackTrace();
                    JYDLogUtil.e("Not Found /sys/class/net/wlan0/address");
                }
            }
            if (macSerial == null || "".equals(macSerial)) {
                try {
                    ...
                    JYDLogUtil.e("Not Found /sys/class/net/eth0/address");
                }
            }
    ...
    public static String getLocalMacAddress() {
        ...
        if (!AppInfo.checkPermission(ExtApp.app().getApplicationContext(), permission)) {
            JYDLogUtil.e("!!!MISSING permission [" + permission + "]");
            return "";
        } else {
